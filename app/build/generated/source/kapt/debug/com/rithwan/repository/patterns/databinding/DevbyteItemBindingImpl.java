...
public class DevbyteItemBindingImpl extends DevbyteItemBinding implements com.rithwan.repository.patterns.generated.callback.OnClickListener.Listener {
    ...
    private DevbyteItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.rithwan.repository.patterns.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.videoCallback == variableId) {
            setVideoCallback((com.rithwan.repository.patterns.ui.VideoClick) variable);
        }
        else if (BR.video == variableId) {
            setVideo((com.rithwan.repository.patterns.domain.DevByteVideo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVideoCallback(@Nullable com.rithwan.repository.patterns.ui.VideoClick VideoCallback) {
    ...
    public void setVideo(@Nullable com.rithwan.repository.patterns.domain.DevByteVideo Video) {
        this.mVideo = Video;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    protected void executeBindings() {
        ...
        com.rithwan.repository.patterns.ui.VideoClick videoCallback = mVideoCallback;
        com.rithwan.repository.patterns.domain.DevByteVideo video = mVideo;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.rithwan.repository.patterns.util.BindingAdaptersKt.setImageUrl(this.videoThumbnail, VideoThumbnail1);
        }
    }
