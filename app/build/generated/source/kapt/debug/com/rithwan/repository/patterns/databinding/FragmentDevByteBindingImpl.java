package com.rithwan.repository.patterns.databinding;
import com.rithwan.repository.patterns.R;
import com.rithwan.repository.patterns.BR;
...
public class FragmentDevByteBindingImpl extends FragmentDevByteBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.rithwan.repository.patterns.viewmodels.DevByteViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.rithwan.repository.patterns.viewmodels.DevByteViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewModelPlaylist((androidx.lifecycle.LiveData<java.util.List<com.rithwan.repository.patterns.domain.DevByteVideo>>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModelPlaylist(androidx.lifecycle.LiveData<java.util.List<com.rithwan.repository.patterns.domain.DevByteVideo>> ViewModelPlaylist, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.rithwan.repository.patterns.viewmodels.DevByteViewModel viewModel = mViewModel;
        androidx.lifecycle.LiveData<java.util.List<com.rithwan.repository.patterns.domain.DevByteVideo>> viewModelPlaylist = null;
        java.util.List<com.rithwan.repository.patterns.domain.DevByteVideo> viewModelPlaylistGetValue = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            com.rithwan.repository.patterns.util.BindingAdaptersKt.hideIfNetworkError(this.loadingSpinner, androidxDatabindingViewDataBindingSafeUnboxViewModelEventNetworkError, viewModelPlaylistGetValue);
        }
    }
